...
export const DEFAULT_NOTIFICATION_PREFERENCES: NotificationPreferences = {
  ...
  emailRecipients: [],
  routing: [
    { priority: 'urgent', channels: ['in-app', 'webhook', 'email'] },
    { priority: 'high', channels: ['in-app', 'webhook', 'email'] },
    { priority: 'normal', channels: ['in-app', 'webhook'] },
    { priority: 'low', channels: ['in-app'] },
  ],
